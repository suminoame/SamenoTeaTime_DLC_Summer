# VRC Tea Time 夏 - 涼やかガラスとアイスティー（Manual DLC/Summer）
...
また、Unity 2022.3.22f1以外のバージョンを使用した場合も同様に正常に動作しなくなる可能性がございます。
...
※最初に炭酸を入れた場合、あとから紅茶を入れることができません。ティーソーダを作る場合は、必ず初めに紅茶を入れる必要があります。
...
- ベリーシロップ（ブルーベリー、ラズベリー ※）
  - ドリンクの種類によって、ブルーベリーとラズベリーのミックス、ブルーベリー単体、ラズベリー単体の場合があります
- ピーチシロップ
- レモンシロップ
